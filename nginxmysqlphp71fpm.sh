...
apt-get install -y nginx php7.1-cli php7.1-gd php7.1-dev php7.1-curl php7.1-memcached php7.1-imap php7.1-mbstring php7.1-xml php7.1-zip php7.1-bcmath php7.1-soap php7.1-intl php7.1-readline php-xdebug php7.1-fpm
