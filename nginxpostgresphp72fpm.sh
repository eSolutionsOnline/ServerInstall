...
apt-get install -y nginx php7.2-cli php7.2-gd php7.2-dev php7.2-curl php7.2-memcached php7.2-imap php7.2-mbstring php7.2-xml php7.2-zip php7.2-bcmath php7.2-soap php7.2-intl php7.2-readline php-xdebug php7.2-fpm postgresql-contrib postgresql php7.2-pgsql
...
sed -i "s/timezone.*/timezone = 'Europe/London'/" /etc/postgresql/9.5/main/postgresql.conf


echo "Updating Test page"
cat > /www/$appname/web/index.php << EOF
